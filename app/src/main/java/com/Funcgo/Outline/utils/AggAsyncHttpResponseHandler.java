...
import com.Funcgo.Outline.eventbus.NeedLoginEvent;
import com.Funcgo.Outline.ui.activity.LoginActivity;
...
public class AggAsyncHttpResponseHandler implements IResponseHandler {
    ...
    public AggAsyncHttpResponseHandler(Context context, CallBack callBack) {
        this.callBack = callBack;
        mLoadingProgressDialog = LoadingProgressDialog.createDialog(context);
    }
    ...
    public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
        ...
        try {
            ...
            if(ret != 200){
                CustomToast.showToast(jsonObject.getString("msg"));
            }else {
                if(callBack != null){
