...
import com.Funcgo.Outline.ui.adapter.PtrLoadMoreListAdapterAction;
import com.Funcgo.Outline.ui.views.AggLoaderMoreFooterView;
...
public abstract class BasePtrLoadMoreFragment extends BaseFragment
    ...
    protected AggAsyncHttpResponseHandler getListResponseHandler() {
        return new AggAsyncHttpResponseHandler(getContext(), null) {
