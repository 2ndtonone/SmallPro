...
public class AppUpdateDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    private float mRemoteVersion = 0;
    private boolean isForce = false;
    private String mDownloadUrl = null;

    public static AppUpdateDialogFragment newInstance(boolean force, String downloadUrl, float remoteVersion) {
    ...
    public void setRemoteVersion(float version) {
